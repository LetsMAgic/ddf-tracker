const CACHE='ddf-tracker-v4.0.0';
const ASSETS=['./','index.html','style.css','app.js','episodes-seed.js','episodes.json','manifest.json','icon-192.png','icon-512.png','apple-touch-icon.png'];
